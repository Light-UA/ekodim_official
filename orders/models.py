...
class Order( models.Model ):
    ...
    requires_delivery_1 = models.BooleanField( default=False, verbose_name="Нова пошта" )
    requires_delivery_2 = models.BooleanField( default=False, verbose_name="Укр пошта" )
    delivery_address = models.TextField( null=True, blank=True, verbose_name="Адрес доставки" )
    payment_on_get = models.BooleanField( default=False, verbose_name="Оплата при отриманні" )
    is_paid = models.BooleanField( default=False, verbose_name="Оплата карткою" )
